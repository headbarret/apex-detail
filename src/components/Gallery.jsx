...
const PHOTOS = [
  {
    ...
    thumb: `${process.env.PUBLIC_URL}/images/gallery-1.jpg`,
    label: "Описание",
  },
  {
    id: 2,
    src: `${process.env.PUBLIC_URL}/images/gallery-2.jpg`,
    thumb: `${process.env.PUBLIC_URL}/images/gallery-2.jpg`,
    label: "Описание",
  },
  {
    id: 3,
    src: `${process.env.PUBLIC_URL}/images/gallery-3.jpg`,
    thumb: `${process.env.PUBLIC_URL}/images/gallery-3.jpg`,
    label: "Описание",
  },
  {
    id: 4,
    src: `${process.env.PUBLIC_URL}/images/gallery-4.jpg`,
    thumb: `${process.env.PUBLIC_URL}/images/gallery-4.jpg`,
    label: "Описание",
  },
  {
    id: 5,
    src: `${process.env.PUBLIC_URL}/images/gallery-5.jpg`,
    thumb: `${process.env.PUBLIC_URL}/images/gallery-5.jpg`,
    label: "Описание",
  },
  {
    id: 6,
    src: `${process.env.PUBLIC_URL}/images/gallery-6.jpg`,
    thumb: `${process.env.PUBLIC_URL}/images/gallery-6.jpg`,
    label: "Описание",
  },
];
